...
class RevenueExpenseEntry(models.Model):
    ...
    amount = models.DecimalField(max_digits=15, decimal_places=3, validators=[MinValueValidator(Decimal('0.001'))], verbose_name=_('المبلغ'))
    
    # إضافة حقل العملة
    currency = models.ForeignKey('settings.Currency', on_delete=models.PROTECT, null=True, blank=True, verbose_name=_('العملة'))
