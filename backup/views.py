...
class BackupRestoreView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        basic_accounts_codes = [
            '101', '102', '103', '1031', '104', '1041', '1101', '1201', '1301', '1302', '1303', '1070',  # الأصول المتداولة
            '1401', '1402', '1403', '1501', '1502', '1601',  # الأصول غير المتداولة
            '2030', '2101', '2102', '2103', '2201', '2301', '2302', '2401', '2402', '2501', '2503',  # المطلوبات المتداولة
            '2202', '2502',  # المطلوبات طويلة الأجل
            '301', '305', '3101', '3102', '3202', '3203', '3204',  # حقوق الملكية
            '401', '4011', '4012', '4022', '403', '404', '4099',  # الإيرادات
            '501', '5011', '5012', '502', '5021', '5022', '5023', '503', '5031', '504', '505', '506', '507', '5099',  # المصروفات
            '6101',  # المشتريات
            '7101'   # المبيعات
        ]
