...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # لتقديم الملفات الثابتة على Render
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # أضف هذا المسار لو تستخدم مجلد templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
