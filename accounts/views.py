...
class LoginView(auth_views.LoginView):
    ...
    def get_success_url(self):
        # إذا كان المستخدم من نوع "نقطة البيع فقط"، توجيهه إلى شاشة نقطة البيع
        if self.request.user.is_authenticated and hasattr(self.request.user, 'is_pos_only_user') and self.request.user.is_pos_only_user():
